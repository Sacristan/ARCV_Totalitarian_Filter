...
{
	Mat img_1 = imread("images/ussr_sucks/source_ussr_6.jpg");
	Mat img_2 = imread("images/ussr_sucks/template_ussr.jpg");

	//Mat img_1 = imread("images/nazi_germany_sucks/source_nazi_5.jpg");
	//Mat img_2 = imread("images/nazi_germany_sucks/template_nazi.jpg");
